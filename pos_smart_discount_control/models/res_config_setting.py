...
class ResConfigSettings(models.TransientModel):
    ...
    show_stock_qty = fields.Boolean(string="Show Available Stock in POS", readonly=False, related='pos_config_id.show_stock_qty')

    show_bl_a4 = fields.Boolean(string="Show 'Print A4 BL' Button", readonly=False, related='pos_config_id.show_bl_a4')
    bl_docx_template_id = fields.Integer(string="BL Docx Template ID", readonly=False, related='pos_config_id.bl_docx_template_id')